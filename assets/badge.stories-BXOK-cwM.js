import{j as e}from"./jsx-runtime-Bz4aBVDn.js";import{B as s}from"./badge-B3XW2gOL.js";import{S as h}from"./star-C0TOQxsF.js";import{C as x}from"./circle-check-big-Cfx7f1FC.js";import{T as g}from"./triangle-alert-CjUeuD09.js";import{H as u}from"./heart-BFGUhVwJ.js";import{S as N}from"./shopping-cart-B6TwTJVd.js";import{Z as j}from"./zap-CbIKWmf2.js";import{X as p}from"./x-BlIlgLCT.js";import"./iframe-BdMZbwUm.js";import"./index-COOYaFQ0.js";import"./index-CdJFUDDL.js";import"./utils-CBfrqCZ4.js";import"./createLucideIcon-CdHLrrBb.js";const I={title:"UI/Base/Badge",component:s,parameters:{layout:"centered",docs:{description:{component:`
...
- \`className\`: string - 추가 CSS 클래스
  ...
  render: () => <div className="flex items-center gap-4">\r
      <div className="relative">\r
        <ShoppingCart className="w-6 h-6" />\r
        <Badge className="absolute -top-2 -right-2 px-1 min-w-5 h-5">3</Badge>\r
      </div>\r
      <div className="relative">\r
        <Heart className="w-6 h-6" />\r
        <Badge variant="destructive" className="absolute -top-2 -right-2 px-1 min-w-5 h-5">12</Badge>\r
      </div>\r
      <div className="relative">\r
        <Star className="w-6 h-6" />\r
        <Badge variant="secondary" className="absolute -top-2 -right-2 px-1 min-w-5 h-5">99+</Badge>\r
      </div>\r
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="space-y-4">\r
      <div className="flex items-center gap-2">\r
        <span className="text-sm">주문 상태:</span>\r
        <Badge>처리 중</Badge>\r
      </div>\r
      <div className="flex items-center gap-2">\r
        <span className="text-sm">배송 상태:</span>\r
        <Badge variant="secondary">\r
      ...
      <div className="flex items-center gap-2">\r
        <span className="text-sm">결제 상태:</span>\r
        <Badge variant="destructive">결제 실패</Badge>\r
      </div>\r
      <div className="flex items-center gap-2">\r
        <span className="text-sm">회원 등급:</span>\r
        <Badge variant="outline">골드</Badge>\r
      </div>\r
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="space-y-3">\r
      <div className="space-y-2">\r
        <h4 className="text-sm font-medium">제품 태그</h4>\r
        <div className="flex flex-wrap gap-2">\r
          <Badge>신상품</Badge>\r
          <Badge variant="secondary">할인</Badge>\r
          <Badge variant="outline">무료배송</Badge>\r
          <Badge>베스트셀러</Badge>\r
        </div>\r
      </div>\r
      <div className="space-y-2">\r
        <h4 className="text-sm font-medium">카테고리</h4>\r
        <div className="flex flex-wrap gap-2">\r
          <Badge variant="outline">전자제품</Badge>\r
          <Badge variant="outline">컴퓨터</Badge>\r
          <Badge variant="outline">노트북</Badge>\r
        </div>\r
      </div>\r
    </div>,
  parameters: {
  ...
  render: () => <div className="space-y-4">\r
      <div className="space-y-2">\r
        <h4 className="text-sm font-medium">클릭 가능한 배지</h4>\r
        <div className="flex gap-2">\r
          <Badge asChild>\r
            <button className="cursor-pointer hover:opacity-80">\r
              필터: 가격\r
              <X className="w-3 h-3 ml-1" />\r
            </button>\r
          </Badge>\r
          <Badge variant="secondary" asChild>\r
            <button className="cursor-pointer hover:opacity-80">\r
              필터: 브랜드\r
              <X className="w-3 h-3 ml-1" />\r
            </button>\r
          </Badge>\r
          <Badge variant="outline" asChild>\r
            <button className="cursor-pointer hover:opacity-80">\r
              필터: 카테고리\r
              <X className="w-3 h-3 ml-1" />\r
            </button>\r
      ...
      \r
      <div className="space-y-2">\r
        <h4 className="text-sm font-medium">링크 배지</h4>\r
        <div className="flex gap-2">\r
          <Badge asChild>\r
            <a href="#" className="cursor-pointer hover:opacity-80">\r
              #React\r
            </a>\r
          </Badge>\r
          <Badge variant="secondary" asChild>\r
  ...
  render: () => <div className="space-y-6">\r
      <div className="space-y-2">\r
        ...
        <p className="text-sm text-muted-foreground">\r
          Badge 컴포넌트의 접근성 기능을 확인해보세요:\r
        </p>\r
        <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1">\r
          <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Tab</kbd> 키로 포커스 이동 (상호작용 가능한 배지)</li>\r
          <li><kbd className="px-2 py-1 bg-muted rounded text-xs">Enter</kbd> 또는 <kbd className="px-2 py-1 bg-muted rounded text-xs">Space</kbd>로 활성화</li>\r
          <li>스크린 리더가 배지 내용을 적절히 읽어줌</li>\r
          <li>색상뿐만 아니라 텍스트로도 정보 전달</li>\r
        </ul>\r
      </div>\r
      \r
      <div className="space-y-3">\r
        <h4 className="text-sm font-medium">포커스 가능한 배지</h4>\r
        <div className="flex gap-2">\r
          <Badge asChild>\r
            <button className="focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" aria-label="중요한 알림을 확인하세요">\r
              <AlertTriangle className="w-3 h-3" />\r
              중요\r
            </button>\r
          </Badge>\r
          <Badge variant="secondary" asChild>\r
            <a href="#" className="focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" aria-label="완료된 작업 목록으로 이동">\r
              <CheckCircle className="w-3 h-3" />\r
              완료\r
            </a>\r
          </Badge>\r
      ...
      \r
      <div className="space-y-3">\r
        <h4 className="text-sm font-medium">상태 표시</h4>\r
        <div className="flex flex-col gap-2">\r
          <div className="flex items-center gap-2">\r
            <span>연결 상태:</span>\r
            <Badge>\r
              <div className="w-2 h-2 bg-green-500 rounded-full mr-1"></div>\r
              온라인\r
            </Badge>\r
          </div>\r
          <div className="flex items-center gap-2">\r
            <span>동기화 상태:</span>\r
            <Badge variant="destructive">\r
              <div className="w-2 h-2 bg-red-500 rounded-full mr-1"></div>\r
              오프라인\r
            </Badge>\r
          </div>\r
        </div>\r
...
}`,...m.parameters?.docs?.source}}};export{m as AccessibilityDemo,a as Default,n as Destructive,o as InteractiveBadges,d as Notifications,i as Outline,l as ProductTags,r as Secondary,c as StatusLabels,t as WithIcons,I as default};
