...
import { 
  Search, Eye, EyeOff, User, Mail, Lock, Phone, Calendar, 
  MapPin, CreditCard, AlertCircle, CheckCircle, Star, 
  Filter, MoreHorizontal, Copy, Download, Settings,
  ChevronDown, X, HelpCircle, ExternalLink
} from "lucide-react"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              onChange={handleChange('validEmail')}
              className="pl-10 pr-10 border-green-500 focus:border-green-500"
            />
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input 
              id="invalid-email" 
              type="email" 
              value={values.invalidEmail}
              onChange={handleChange('invalidEmail')}
              className="pl-10 pr-10 border-red-500 focus:border-red-500"
              aria-invalid="true"
              aria-describedby="email-error"
            />
...
export const SearchInput: Story = {
  render: () => {
    ...
    const [recentSearches] = React.useState([
      "React 튜토리얼", "TypeScript 가이드", "Tailwind CSS", "Storybook 설정"
    ])
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                aria-invalid={formValues.username.length > 0 && formValues.username.length < 3}
              />
            </div>
            <p id="username-help" className="text-sm text-muted-foreground">
              3자 이상의 사용자명을 입력해주세요.
            </p>
            {formValues.username.length > 0 && formValues.username.length < 3 && (
