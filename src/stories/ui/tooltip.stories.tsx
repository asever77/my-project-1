...
import { 
  HelpCircle, Info, AlertCircle, CheckCircle, Star, Heart, 
  Copy, Share, Download, Edit, Trash2, Settings, User,
  Bell, Shield, CreditCard, Calendar, Mail, Phone,
  Home, Briefcase, Coffee, Bookmark, Tag, Clock,
  ExternalLink, Eye, Lock, Unlock, ChevronDown, Plus
} from "lucide-react"
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button 
                  className="p-2 border rounded-md hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary"
                  aria-label="도움말 보기"
                >
                  <HelpCircle className="h-4 w-4" />
                </button>
