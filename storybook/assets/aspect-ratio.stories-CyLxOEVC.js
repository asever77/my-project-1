import{j as e}from"./jsx-runtime-Dad_ikcK.js";import{r as b}from"./iframe-Dg_gISpU.js";import{P as N}from"./index-GcyhyyiP.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C3wj8CDn.js";import"./index-CEfJNQWM.js";var j="AspectRatio",u=b.forwardRef((t,h)=>{const{ratio:x=1/1,style:f,...v}=t;return e.jsx("div",{style:{position:"relative",width:"100%",paddingBottom:`${100/x}%`},"data-radix-aspect-ratio-wrapper":"",children:e.jsx(N.div,{...v,ref:h,style:{...f,position:"absolute",top:0,right:0,bottom:0,left:0}})})});u.displayName=j;var w=u;function s({...t}){return e.jsx(w,{"data-slot":"aspect-ratio",...t})}s.__docgenInfo={description:"",methods:[],displayName:"AspectRatio"};const C={title:"UI/Contents/AspectRatio",component:s,parameters:{layout:"centered",docs:{description:{component:`
...
- **21:9** (2.333): 울트라와이드 모니터
  ...
  render: () => <div className="w-[300px]">
      <AspectRatio ratio={1}>
        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&dpr=2&q=80" alt="프로필 사진" className="rounded-full object-cover w-full h-full" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="w-[400px]">
      <AspectRatio ratio={4 / 3}>
        <img src="https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=800&dpr=2&q=80" alt="전통적인 비율의 풍경" className="rounded-md object-cover w-full h-full" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="w-[450px]">
      <AspectRatio ratio={3 / 2}>
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&dpr=2&q=80" alt="사진 비율 이미지" className="rounded-md object-cover w-full h-full" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="w-[600px]">
      <AspectRatio ratio={21 / 9}>
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&dpr=2&q=80" alt="울트라와이드 풍경" className="rounded-md object-cover w-full h-full" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="w-[500px]">
      <AspectRatio ratio={16 / 9}>
        <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full h-full rounded-md" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="grid grid-cols-2 gap-4 w-[600px]">
      <AspectRatio ratio={1}>
        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&dpr=2&q=80" alt="갤러리 이미지 1" className="rounded-md object-cover w-full h-full hover:scale-105 transition-transform" />
      </AspectRatio>
      <AspectRatio ratio={1}>
        <img src="https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=400&dpr=2&q=80" alt="갤러리 이미지 2" className="rounded-md object-cover w-full h-full hover:scale-105 transition-transform" />
      </AspectRatio>
      <AspectRatio ratio={1}>
        <img src="https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?w=400&dpr=2&q=80" alt="갤러리 이미지 3" className="rounded-md object-cover w-full h-full hover:scale-105 transition-transform" />
      </AspectRatio>
      <AspectRatio ratio={1}>
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&dpr=2&q=80" alt="갤러리 이미지 4" className="rounded-md object-cover w-full h-full hover:scale-105 transition-transform" />
      </AspectRatio>
    </div>,
  parameters: {
    docs: {
  ...
  render: () => <div className="space-y-6 w-[500px]">
      ...
      <AspectRatio ratio={16 / 9}>
        <div className="relative w-full h-full">
          <img src="https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?w=800&dpr=2&q=80" alt="산과 호수가 어우러진 평화로운 자연 풍경. 맑은 물에 산의 실루엣이 반사되어 보이며, 하늘에는 부드러운 구름이 떠있다." className="rounded-md object-cover w-full h-full" />
...
}`,...p.parameters?.docs?.source}}};const T=["Default","Square","Traditional","Photo","Ultrawide","WithVideo","CustomContent","ResponsiveGallery","PlaceholderContent","AccessibilityDemo"];export{p as AccessibilityDemo,n as CustomContent,a as Default,c as Photo,m as PlaceholderContent,l as ResponsiveGallery,r as Square,o as Traditional,d as Ultrawide,i as WithVideo,T as __namedExportsOrder,C as default};
